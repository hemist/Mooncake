...
class MasterMetricManager {
   public:
    ...
    void inc_ram_key_count(int64_t val = 1);
    void dec_ram_key_count(int64_t val = 1);
    void inc_cxl_key_count(int64_t val = 1);
    void dec_cxl_key_count(int64_t val = 1);
    ...
    int64_t get_ram_key_count();
    int64_t get_cxl_key_count();
   ...
   private:
    ...
    ylt::metric::gauge_t ram_key_count_;
    ylt::metric::gauge_t cxl_key_count_;
