...
option(USE_CXL_DSA "option for enabling DSA for accerating CXL memcpy" OFF)
option(USE_CXL_CUDA "option for enabling CXL to VRAM transport by CUDA" ON)
...
if (USE_CXL_DSA)
  add_compile_definitions(USE_CXL_DSA)
  message(STATUS "CXL_DSA support is enabled")
endif()
